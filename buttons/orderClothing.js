...
const ORDER_TYPES = {
  clothing: {
    ...
    buttonId: "p_284217578547580930",
    label: "Clothing"
  }
};

module.exports = {
  customId: ORDER_TYPES.clothing.buttonId,

  async execute(interaction) {
    const config = ORDER_TYPES.clothing;
    ...
    const existing = guild.channels.cache.find(
      channel =>
        ...
        channel.topic === `clothing-${user.id}`
    );
