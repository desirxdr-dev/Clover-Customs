...
const ORDER_TYPES = {
  graphics: {
    ...
    buttonId: "p_284217574709792769",
    label: "Graphics"
  }
};

module.exports = {
  customId: ORDER_TYPES.graphics.buttonId,

  async execute(interaction) {
    const config = ORDER_TYPES.graphics;
    ...
    const existing = guild.channels.cache.find(
      channel =>
        ...
        channel.topic === `graphics-${user.id}`
    );
